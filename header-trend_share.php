...
<html lang="en">
  <head>
    <link rel="canonical" href="https://researchlytic.com/research-trends/">
    <meta name="robots" content="noindex">
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    <title>Research Trends: Discover the Latest Developments in Your Field</title>
    <meta name="description" content="Stay current with research trends in your field. Discover publication interest over time, regional trends, institutions, publishers, journals, researchers and more." />
    ...
    <?php wp_head(); ?>
      ...
      <!-- Facebook Meta Image -->
      <meta property="og:image" content="https://researchlytic.com/wp-content/themes/researchlytic/assets/images/opengraph/research-trends-opengraph.webp">
      <!-- Twitter Meta Image -->
      <meta name="twitter:image" content="https://researchlytic.com/wp-content/themes/researchlytic/assets/images/opengraph/research-trends-opengraph.webp">
  ...
  <body>
    ...
    <header>
      ...
      <div id="q_label_row">
            <h1>
                <span id="q_label">Research Trends</span>
                <span id="q_label_description">Discover what the world is researching about</span>
            </h1>
      </div>
      <div id="q_row">
        <form id="q_form">
