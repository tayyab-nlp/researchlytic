...
function content_logic(){
    ...
    if (window.location.href!="https://researchlytic.com/scholarly-literature/" && !q) {
        window.location = "/scholarly-literature/";
    } 
    
    if (window.location.href.includes("https://researchlytic.com/scholarly-literature/") && q) {
...
filter_btn.onclick = function (){
    ...
    var q = document.getElementById("q");
	if (window.location.href == "https://researchlytic.com/scholarly-literature/"){
	    if (q.value.trim() !== "") {
          window.location.href = "/literature?q=" + encodeURIComponent(q.value);
        }
	}
	...
	var newUrl = "https://researchlytic.com/literature/?q="+getPara().q.replace(/ /g,"-")+"&td="+getPara().t+"&pd="+getPara().pd+"&sub="+getPara().s+"&typ="+getPara().tp+"&cp=1";
...
function display_papers(jsonArr, i_start, i_end){
    ...
    for (var i = i_start; i < i_end; i++){
        ...
        col.innerHTML += "<p style='font-size:14px; font-weight:400; margin-top:1px; margin-bottom:1px; color:#006621; padding:5px;'>"+journal+" - "+authors+" - "+year+"</p>";
        

        // if there are concepts, show
        if (jsonArr[i]['concepts'][0] != undefined){
            col.innerHTML += "<hr style='margin-top:0px; margin-bottom:2px; display: block; height: 1px; border: 0; border-top: 1px solid #ffffff;'>";
            col.innerHTML += "<span class='tag_title'>Concepts found:</span>";
            col.innerHTML += "<span class='tag'>"+jsonArr[i]['concepts'][0]+"</span>";
        }
        
        if (jsonArr[i]['concepts'][1] != undefined){
            col.innerHTML += "<span class='tag'>"+jsonArr[i]['concepts'][1]+"</span>";
        }

        if (jsonArr[i]['concepts'][2] != undefined){
           col.innerHTML += "<span class='tag'>"+jsonArr[i]['concepts'][2]+"</span>";
        }
       
        // if categories are found, show
        if (jsonArr[i]['categories'][0] != "None"){
            col.innerHTML += "<hr style='margin-top:2px; margin-bottom:2px; display: block; height: 1px; border: 0; border-top: 1px solid #ffffff;'>";
            col.innerHTML += "<span class='tag_title'>May help you in:</span>";
            col.innerHTML += "<span class='tag'>"+jsonArr[i]['categories'][0]+"</span>";
        }

        if (jsonArr[i]['categories'][1] != undefined){
            col.innerHTML += "<span class='tag'>"+jsonArr[i]['categories'][1]+"</span>";
        }   

        if (jsonArr[i]['categories'][2] != undefined){
            col.innerHTML += "<span class='tag'>"+jsonArr[i]['categories'][2]+"</span>";
        }   
        ...
        if (is_oa){
            col.innerHTML += "<span><a class='view_btn' href='"+url+"'>View PDF</a></span>";
        }
        else {
            col.innerHTML += "<span><a class='view_btn' href='"+url+"'>View Online</a></span>";
        }

        col.innerHTML += "<span><a class='cite_btn' href='/references/?q="+title+"'>Cite</a></span>";
        col.innerHTML += "<span class='save_btn'>Save</span>";
...
function active_page(jsonArr, page_id, i_start, i_end){
        document.getElementById(page_id).onclick = function (){ 
            ...
            // update url 
            var newUrl = "https://researchlytic.com/literature/?q="+getPara().q.replace(/ /g,"-")+"&td="+getPara().t+"&pd="+getPara().pd+"&sub="+getPara().s+"&typ="+getPara().tp+"&cp="+page_id;
    ...
    save_btns.forEach(function (btn){
        btn.onclick = function (){
            ...
            if (document.querySelector("#sign_up").innerText !="Sign up"){
                ...
                xhr.open("GET", "/saved_item.php?t=study_sav&title=" + encodeURIComponent(title), true);
                ...
                alert("Please Sign in to save your favourite studies");
            }
...
function check_saved_study (id){
    ...
    xhr.open('GET', 'https://researchlytic.com/saved_item.php?t=study_check&title=' + study.innerText, true);
