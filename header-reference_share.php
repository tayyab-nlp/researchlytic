...
<html lang="en">
  <head>
    <link rel="canonical" href="https://researchlytic.com/reference-manager/">
    ...
    <title>Reference Manager: Effortlessly Organize & Manage Your References</title>
    <meta name="description" content="Easily organize and manage all of your references with our reference manager. Import from various sources, create custom styles, export in preferred format, and more." />
    ...
    <!-- Facebook Meta Image -->
    <meta property="og:image" content="https://researchlytic.com/wp-content/themes/researchlytic/assets/images/opengraph/reference-manager-opengraph.webp">
    <!-- Twitter Meta Image -->
    <meta name="twitter:image" content="https://researchlytic.com/wp-content/themes/researchlytic/assets/images/opengraph/reference-manager-opengraph.webp">
  ...
  <body>
    ...
    <header>
      ...
      <div id="q_label_row">
            <h1>
                <span id="q_label">Reference Manager</span>
                <span id="q_label_description">Easily Create and Manage Your References</span>
                                               
            </h1>
      </div>
      <div id="q_row">
        <form id="q_form">
          <input id="q" type="text" placeholder="Enter a study title" autocomplete="off" />
